...
HUB_SAFE_DIST               =  0.5  # metres from hub EDGE — proximity penalty starts here
RW_HUB_PROXIMITY            = -1.5  # per-step at d=0; linear ramp → ~-0.47/step at collision boundary (0.343m from edge)
