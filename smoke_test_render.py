...
Drives the robot with a simple rule-based controller (point toward next waypoint)
to verify the renderer looks correct before training. Close the window to exit.
"""
...
def main():
    ...
    while running:
        ...
        # Convert world-frame direction to robot-frame (heading=0 so same here)
        import numpy as np
