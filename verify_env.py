"""
verify_env.py
Runs a quick random-policy rollout and checks that the environment is well-formed.
No display required — purely checks shapes, ranges, and termination conditions.
"""

import numpy as np
from swerve_env import SwerveEnv, OBS_DIM
...
# Random rollout — track reward stats and done conditions
rewards = []
total_steps = 0
episodes    = 0
max_eps     = 10
